...
set CLASSPATH=%APP_HOME%\lib\server-2023.jar;%APP_HOME%\lib\protocol-2023.jar


@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" ch.zhaw.pm2.multichat.server.Server %*
